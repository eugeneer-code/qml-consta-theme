 ...
 * All colors are from css source code: https://github.com/consta-design-system/uikit/blob/master/src/components/Theme/_color/Theme_color_gpnDisplay.css
 */
QtObject {
    property color project: "#0071b2"

    // Base colors
    property color base: "#f6fbfd"
    property color essential: "#002033"
    property color phantom: "#f6fbfd"
    property color path: "#0078d2"
    property color system: "#4b6272"
    property color shadow: "#000306"
    ...
    property color bg_secondary: _ConstaUtils.hsla(essential, "+0", "+25", "+4", "100%")
    property color bg_brand: project
    property color bg_link: path
    property color bg_border: _ConstaUtils.alpha(phantom, 0.28)
    property color bg_stripe: _ConstaUtils.alpha(phantom, 0.05)
    property color bg_ghost: _ConstaUtils.alpha(phantom, 0.08)
    property color bg_tone: _ConstaUtils.hsla(phantom, "+0", "+100%", "-92", "85%")
    property color bg_soft: _ConstaUtils.hsla(essential, "+0", "+0", "+100", "90%")
    property color bg_system: _ConstaUtils.hsla(system, "213", "45", "35", "100%")
    ...
    property color typo_system: _ConstaUtils.hsla(system, "213", "47", "47", "100%")
    ...
    property color control_bg_active: _ConstaUtils.alpha(path, 0.8)
    ...
    property color control_bg_ghost: _ConstaUtils.alpha(phantom, 0.16)
    property color control_bg_ghost_hover: _ConstaUtils.alpha(phantom, 0.23)
    ...
    property color control_bg_clear_hover: _ConstaUtils.alpha(phantom, 0.23)
    ...
    property color control_bg_disable: _ConstaUtils.alpha(phantom, 0.16)
